COMPLAIN_LIST_BASE_URL = "https://www.reclameaqui.com.br/empresa/{}/lista-reclamacoes/?pagina=1&status=EVALUATED"
...
COMPLAIN_TEXT2_SELECTOR = 'div[data-testid="complaint-evaluation-interaction"]' #consideração final do consumidor - texto - status - voltaria a fazer negocio - nota
# OBS a linha 9 so funciona se olhar a pagina de avaliadas
#'p[data-testid="disabled-complaint"]' quando a reclamação é desativada
...
CSV_FILE_HEADERS = ['url', 'titulo', 'texto', 'status', 'local',
                    'data_hora', 'problem_type', 'product_type', 'category', 'texto2']
